! function() {
    ...
    function M(e, t) {
        ...
        if (!(e instanceof Array)) return M([e], t);
        if (!(t instanceof Array)) return M(e, [t]);
    ...
    var m, g, O = (v.extractHostname = function(e) {
        ...
        var t, n = v.getHighestAccessibleWindow(e),
            o = n.topFrame;
        if (n.err) try {
            try {
    ...
    function N(e) {
        var t = e;
        if (e instanceof Function) return (t = e()) instanceof Function ? t : N(t);
        if (e instanceof Array) {
            t = [];
            for (var n = 0; n < e.length; ++n) t[n] = N(e[n])
    ...
    function W(e, t) {
        for (var n = 0, o = e; n < o.length; n++) {
            var i = o[n];
            if (i.event === t.event && M(t.account, i.account) && i.hash_method === t.hash_method) return void(void 0 !== t.email && (i.email = h(i.email instanceof Array || void 0 === i.email ? i.email : [i.email], t.email instanceof Array ? t.email : [t.email])))
        }
        e.push(t)
    }
    ...
    var y = (w.checkLocalStorageIsWritable = function() {
        ...
        var e = new w("criteo_write_test", 1e4);
    ...
    function C(e, t, n, o) {
        this.readonlyCookieRetentionTime = 0, this.optoutCookieRetentionTime = 15768e7, this.identificationCookieRetentionTime = 34164e6, this.axidCookie = new y("cto_axid", this.readonlyCookieRetentionTime), this.optoutCookie = new y("cto_optout", this.optoutCookieRetentionTime), this.pxsigCookie = new y("cto_pxsig", this.readonlyCookieRetentionTime), this.secureIdCookie = new y("cto_sid", this.identificationCookieRetentionTime), this.bundleCookie = new y("cto_bundle", this.identificationCookieRetentionTime), this.ifaCookie = new y("id_controller_ifa", this.identificationCookieRetentionTime), this.canWriteCookie = !1, this.canWriteLocalStorage = !1, this.clickOriginPayload = null, this.tld = this.getTld(), this.privateMode = this.getPrivateMode(t, n), this.exceptionHandler = e, this.config = o
    }
    var j = (k.prototype.createIframe = function(e, t, n, o) {
        var i = document.createElement("iframe"),
            r = encodeURIComponent || escape,
            a = O.getHighestAccessibleUrl(window),
            s = r(O.extractHostname(a)),
    ...
    var B = new RegExp(/^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i),
        G = (b.prototype.canRetrieveMetrics = function() {
    ...
    function z(e, t, n, o, i) {
        if (function() {
                ...
                var t = "enable" === e[1],
                    n = Number(e[3]);
                new y("criteoTagDebugMode", t ? 864e5 : 0).setValueWithNoDomain(t && n && !isNaN(n) ? String(n) : "0"), window.location.href = window.location.href.substr(0, window.location.href.indexOf("#"))
                ...
                switch (s.event) {
                    ...
                    case "setidentity":
                        if (s.hasOwnProperty("identity")) {
                            ...
                            if (0 < (m = x(m)).length) return s.identity = m, e.actions.push(N(s)), 1
                        }
                        return 0;
                    case "setsitetype":
                        var g = "d";
                ...
                return w.checkAcid(), w.checkClientSideIdentityStatus(), w.setCop(window),
                    ...
                    function(e) {
                        try {
                            ...
                            if (t)
                                if (t.hostname !== document.location.hostname) U(e, {
                                    event: "setData",
