...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_measurementId": "G-4220TB38WC",
                ...
                "vtp_conversionId": "737815034",
                "vtp_conversionLabel": "RhfECLCy8s0BEPrT6N8C",
                "vtp_rdp": true,
                "vtp_url": ["macro", 5],
                ...
                "metadata": ["map"],
                "once_per_event": true,
                "vtp_html": "\u003Cscript async defer data-domain=\"buymeacoffee.com\" data-gtmsrc=\"https:\/\/plausible.io\/js\/plausible.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n",
            ...
            "predicates": [{
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "header-btn halvetica-500 fs-18 m-l-16 open-signp-modal c-pointer mobile-menu-item header-btn-dark push-right"
            }, {
                "function": "_eq",
                "arg0": ["macro", 1],
                "arg1": "gtm.click"
                ...
                "function": "_eq",
                "arg0": ["macro", 2],
                "arg1": "signup-submit-modal"
            }, {
                "function": "_eq",
                "arg0": ["macro", 2],
                "arg1": "fb-signup-modal"
            }, {
                "function": "_cn",
                "arg0": ["macro", 3],
                "arg1": "https:\/\/www.buymeacoffee.com\/auth\/google"
            }, {
                "function": "_cn",
                "arg0": ["macro", 4],
                "arg1": "select-payment-mode"
            }],
            "rules": [
                [
                    ["if", 0, 1],
                ...
                [
                    ["if", 2],
                    ["add", 1, 2, 7, 9, 10, 11, 12, 13, 18, 19, 20, 14, 15, 16, 17]
                ],
                [
                    ["if", 1, 3],
                    ["add", 3]
    ...
    */
    ...
    O.ad = "c10";
    O.U = "dataLayer";
    O.Wg = "ChEIgMKgjgYQyf+At9r9guLuARIkACAmDjT7oAN/UUGvQQfRNEUdp9podwfsS/0wn+K0SV9WenSLGgIszw\x3d\x3d";
    var Gd = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var Kd = Jd,
        ...
        Md = null,
        Nd = null,
        Od = "https://www.googletagmanager.com/a?id=" + O.J + "&cv=45",
        Pd = {},
        Qd = {},
        Rd = function() {
            var a = R.sequence || 1;
        ...
        function() {
            (function(a) {
                ...
                if (ta(b) && 0 === b.indexOf("G-")) {
                    var c = Pq(a.vtp_fieldsToSet, "name", "value") || {};
                    if (c.hasOwnProperty(N.Ja) || a.vtp_userProperties) {
                        var d = c[N.Ja] || {};
                        H(Pq(a.vtp_userProperties, "name", "value"), d);
                        c[N.Ja] = d
                    }
                    a.vtp_enableSendToServerContainer && a.vtp_serverContainerUrl && (c[N.oa] = a.vtp_serverContainerUrl, c[N.ac] = !0);
                    var e = a.vtp_userDataVariable;
                    e && (c[N.xa] = e);
                    Qq(c, N.$d, function(f) {
                        return Ga(f)
                    });
                    Qq(c, N.ae, function(f) {
                        return Number(f)
                    });
