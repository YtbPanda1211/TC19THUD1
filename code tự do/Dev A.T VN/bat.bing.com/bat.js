function UET(o) {
    ...
    this.knownEvents = {
        ...
        login: ["method"],
        page_view: ["page_title", "page_location", "page_path", "rep", "tpp", "gtm_tag_source"],
    ...
    this.evt = function(n, t, i, r) {
        ...
        if (r = r !== !1, i = i || {}, this.evqDispatch === !1 && this.dispatchq(!0), this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object") {
            if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), r ? this.validateDataObject(n, i) : (i.event_action = t, n === this.customEvt && i.hasOwnProperty("gtm_tag_source") && (i = this.mapGtmParams(i)), i = this.validateDataObjectNew(n, i)), n === this.customEvt) {
                s = [];
                for (v in i) s.push(v);
