/*! emojione 12-07-2017 */ ! function(ns) {
    ns.emojioneList = {
        ":kiss_mm:": {
    ...
    for (emoji in ns.emojioneList)
        if (ns.emojioneList.hasOwnProperty(emoji) && "" !== emoji) {
            ...
            for (var i = 0; i < ns.emojioneList[emoji].shortnames.length; i++) tmpShortNames.push(ns.emojioneList[emoji].shortnames[i].replace(/[+]/g, "\\$&"))
        }
    ns.shortnames = tmpShortNames.join("|"), ns.jsEscapeMap = {
        ...
        return str = str.replace(ns.regShortNames, function(shortname) {
            return "undefined" != typeof shortname && "" !== shortname && shortname in ns.emojioneList ? (unicode = ns.emojioneList[shortname].uc_output, "undefined" != typeof unicodeToAscii[unicode] ? unicodeToAscii[unicode] : shortname) : shortname
        })
    }, ns.shortnameToUnicode = function(str) {
        var unicode, fname;
        if (str = str.replace(ns.regShortNames, function(shortname) {
                return "undefined" != typeof shortname && "" !== shortname && shortname in ns.emojioneList ? (unicode = ns.emojioneList[shortname].uc_output.toUpperCase(), fname = ns.emojioneList[shortname].uc_base, ns.convert(unicode)) : shortname
            }), ns.ascii) {
        ...
        if (str = str.replace(ns.regShortNames, function(shortname) {
                if ("undefined" == typeof shortname || "" === shortname || ns.shortnames.indexOf(shortname) === -1) return shortname;
                ...
                return unicode = ns.emojioneList[shortname].uc_output, fname = ns.emojioneList[shortname].uc_base, category = fname.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + shortname + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", ePath = ns.imagePathPNG != ns.defaultPathPNG ? ns.imagePathPNG : ns.defaultPathPNG + ns.emojiSize + "/", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : shortname, replaceWith = ns.sprites ? '<span class="emojione emojione-' + size + "-" + category + " _" + fname + '" ' + title + ">" + alt + "</span>" : '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ePath + fname + '.png"/>'
            }), ns.ascii) {
            var asciiRX = ns.riskyMatchAscii ? ns.regAsciiRisky : ns.regAscii;
            str = str.replace(asciiRX, function(entire, m1, m2, m3) {
                return "undefined" != typeof m3 && "" !== m3 && ns.unescapeHTML(m3) in ns.asciiList ? (m3 = ns.unescapeHTML(m3), unicode = ns.asciiList[m3], shortname = mappedUnicode[unicode], category = unicode.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + ns.escapeHTML(m3) + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", ePath = ns.imagePathPNG != ns.defaultPathPNG ? ns.imagePathPNG : ns.defaultPathPNG + ns.emojiSize + "/", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : ns.escapeHTML(m3), replaceWith = ns.sprites ? m2 + '<span class="emojione emojione-' + size + "-" + category + " _" + unicode + '"  ' + title + ">" + alt + "</span>" : m2 + '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ePath + unicode + '.png"/>') : entire
            })
        }
        return str
    }, ns.unicodeToImage = function(str) {
        var replaceWith, unicode, short, fname, alt, category, title, size, ePath, mappedUnicode = ns.mapUnicodeToShort(),
            eList = ns.emojioneList;
        if (str = str.replace(ns.regUnicode, function(unicodeChar) {
                if ("undefined" == typeof unicodeChar || "" === unicodeChar) return unicodeChar;
                if (unicodeChar in ns.jsEscapeMap) fname = ns.jsEscapeMap[unicodeChar];
                else {
                    if (!(ns.greedyMatch && unicodeChar in ns.jsEscapeMapGreedy)) return unicodeChar;
                    fname = ns.jsEscapeMapGreedy[unicodeChar]
                }
                return short = mappedUnicode[fname], fname = eList[short].uc_base, unicode = eList[short].uc_output, category = fname.includes("-1f3f") ? "diversity" : eList[short].category, size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", ePath = ns.imagePathPNG != ns.defaultPathPNG ? ns.imagePathPNG : ns.defaultPathPNG + ns.emojiSize + "/", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : short, title = ns.imageTitleTag ? 'title="' + short + '"' : "", replaceWith = ns.sprites ? '<span class="emojione emojione-' + size + "-" + category + " _" + fname + '" ' + title + ">" + alt + "</span>" : '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ePath + fname + '.png"/>'
            }), ns.ascii) {
            var asciiRX = ns.riskyMatchAscii ? ns.regAsciiRisky : ns.regAscii;
            str = str.replace(asciiRX, function(entire, m1, m2, m3) {
                return "undefined" != typeof m3 && "" !== m3 && ns.unescapeHTML(m3) in ns.asciiList ? (m3 = ns.unescapeHTML(m3), unicode = ns.asciiList[m3], shortname = mappedUnicode[unicode], category = unicode.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + ns.escapeHTML(m3) + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", ePath = ns.imagePathPNG != ns.defaultPathPNG ? ns.imagePathPNG : ns.defaultPathPNG + ns.emojiSize + "/", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : ns.escapeHTML(m3), replaceWith = ns.sprites ? m2 + '<span class="emojione emojione-' + size + "-" + category + " _" + unicode + '"  ' + title + ">" + alt + "</span>" : m2 + '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ePath + unicode + '.png"/>') : entire
        ...
        var emoji, map = [];
        for (emoji in ns.emojioneList) ns.emojioneList.hasOwnProperty(emoji) && "" !== emoji && (map[ns.convert(ns.emojioneList[emoji].uc_output)] = emoji);
        return map
    }, ns.unicodeCharRegex = function() {
        var map = [];
        for (emoji in ns.emojioneList) ns.emojioneList.hasOwnProperty(emoji) && "" !== emoji && map.push(ns.convert(ns.emojioneList[emoji].uc_output));
        return map.join("|")
        ...
        return ns.memMapShortToUnicode || (ns.memMapShortToUnicode = {}, ns.mapEmojioneList(function(unicode, shortname) {
            ns.memMapShortToUnicode[unicode] = shortname
        })), ns.memMapShortToUnicode
    }, ns.memorizeReplacement = function() {
        if (!ns.unicodeReplacementRegEx || !ns.memMapShortToUnicodeCharacters) {
            var unicodeList = [];
            ns.memMapShortToUnicodeCharacters = {}, ns.mapEmojioneList(function(unicode, shortname) {
