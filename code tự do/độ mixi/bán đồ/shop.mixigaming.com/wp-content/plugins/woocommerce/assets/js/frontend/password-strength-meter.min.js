! function(a) {
    ...
    var d = {
        init: function() {
            a(document.body).on("keyup change", "form.register #reg_password, form.checkout #account_password, form.edit-account #password_1, form.lost_reset_password #password_1", this.strengthMeter), a("form.checkout #createaccount").trigger("change")
        },
        strengthMeter: function() {
            ...
            d.includeMeter(s, e), e = d.checkPasswordStrength(s, e), wc_password_strength_meter_params.stop_checkout && (o = !0), 0 < t.length && e < wc_password_strength_meter_params.min_password_strength && -1 !== e && o ? r.attr("disabled", "disabled").addClass("disabled") : r.prop("disabled", !1).removeClass("disabled")
        },
        includeMeter: function(s, r) {
            s = s.find(".woocommerce-password-strength");
            "" === r.val() ? (s.hide(), a(document.body).trigger("wc-password-strength-hide")) : 0 === s.length ? (r.after('<div class="woocommerce-password-strength" aria-live="polite"></div>'), a(document.body).trigger("wc-password-strength-added")) : (s.show(), a(document.body).trigger("wc-password-strength-show"))
        },
        checkPasswordStrength: function(s, r) {
            var e = s.find(".woocommerce-password-strength"),
                ...
                o = "";
            if (e.removeClass("short bad good strong"), s.remove(), e.is(":hidden")) return r;
